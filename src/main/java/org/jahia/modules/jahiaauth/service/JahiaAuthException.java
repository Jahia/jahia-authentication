...
public class JahiaAuthException extends Exception {
    ...
    public JahiaAuthException(String message) {
        super(message);
    }

    public JahiaAuthException(String message, Throwable cause) {
        super(message, cause);
    }

    public JahiaAuthException(Throwable cause) {
        super(cause);
    }
}
